...
file_paths = ["data/quickSortDataBig.txt", "data/hybridSortDataBig.txt", "data/DPQuickSortDataBig.txt", "data/mergeSortDataBig.txt", "data/newSortDataBig.txt"]
titles = [
    "Avg_no_comps",
    "Avg_no_swaps",
    "Comps_divided_by_N",
...
labels = ["Quick Sort", "Hybrid Sort", "DP Quick Sort", "Merge Sort", "New Sort"]
colors = ["magenta", "green", "blue", "black", "red"]
subfolder = "N_from_1000_to_50000/"
